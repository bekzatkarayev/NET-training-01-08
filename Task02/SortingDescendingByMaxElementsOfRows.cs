...
{
    /// <summary>
    /// Contains implementation of a method that sorts rows of an integer matrix by the largest element of each row in descending order. 
    /// </summary>
    public class SortingDescendingByMaxElementsOfRows : MatrixOperations
    {
        /// <summary>
        /// Sorts an integer matrix by the largest element of each row in descending order.
        /// </summary>
