...
{
    /// <summary>
    /// Contains implementation of a method that sorts rows of an integer matrix by the smallest element of each row in ascending order. 
    /// </summary>
    public class SortingAscendingByMinElementsOfRows : MatrixOperations
    {
        /// <summary>
        /// Sorts an integer matrix by the smallest element of each row in ascending order.
        /// </summary>
