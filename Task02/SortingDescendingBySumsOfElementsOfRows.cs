...
{
    /// <summary>
    /// Contains implementation of a method that sorts rows of an integer matrix by sum of their elements in descending order. 
    /// </summary>
    public class SortingDescendingBySumsOfElementsOfRows : MatrixOperations
    {
        /// <summary>
        /// Sorts an integer matrix by sum of the elements in each row in descending order.
        /// </summary>
